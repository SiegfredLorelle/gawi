 ...
 * happened to still be loading. The same ten lines sit in `:app`'s test set: two copies, because no
 * shared test module exists and one for this would be more machinery than the
